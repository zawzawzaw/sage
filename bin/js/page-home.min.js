...
sagewest.page.Default.prototype.scroll_to_after_the_fold=function(){var target_y=this.window_height-108;if(manic.IS_ACTUAL_MOBILE==true)if(manic.IS_TABLET_LANDSCAPE==true){target_y=this.window_height-$("#mobile-header").height()*.9;console.log("here lies something");console.log("target_y: "+target_y)}else target_y=this.window_height-$("#mobile-header").height();TweenMax.to(this.window,.5,{scrollTo:{y:target_y,autoKill:true},ease:Quad.easeInOut})};goog.exportSymbol("sagewest.page.Default",sagewest.page.Default);goog.provide("sagewest.page.Home");goog.require("sagewest.page.Default");goog.require("manic.google.Map");sagewest.page.Home=function(options,element){sagewest.page.Default.call(this,options,element);this.options=$.extend(this.options,sagewest.page.Home.DEFAULT,options);this.experience_carousel=null;this.contact_map=null};goog.inherits(sagewest.page.Home,sagewest.page.Default);sagewest.page.Home.DEFAULT={};
sagewest.page.Home.prototype.init=function(){sagewest.page.Home.superClass_.init.call(this);this.create_experience_slider();this.create_contact_map();this.create_instagram();this.update_page_layout()};sagewest.page.Home.prototype.create_experience_slider=function(){this.experience_carousel=$("#home-experience-carousel").slick({"speed":350,"dots":false,"arrows":false,"infinite":false,"slidesToShow":1,"slidesToScroll":1,"pauseOnHover":true,"autoplay":true,"autoplaySpeed":4E3})};
sagewest.page.Home.prototype.create_contact_map=function(){this.contact_map=new manic.google.Map({"lat":-31.947952,"lng":115.8386173,"has_scrollwheel":false,"zoom":16,"google_style_array":[{"featureType":"water","elementType":"geometry.fill","stylers":[{"color":"#d3d3d3"}]},{"featureType":"transit","stylers":[{"color":"#808080"},{"visibility":"off"}]},{"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"visibility":"on"},{"color":"#b3b3b3"}]},{"featureType":"road.highway","elementType":"geometry.fill",
"stylers":[{"color":"#ffffff"}]},{"featureType":"road.local","elementType":"geometry.fill","stylers":[{"visibility":"on"},{"color":"#ffffff"},{"weight":1.8}]},{"featureType":"road.local","elementType":"geometry.stroke","stylers":[{"color":"#d7d7d7"}]},{"featureType":"poi","elementType":"geometry.fill","stylers":[{"visibility":"on"},{"color":"#ebebeb"}]},{"featureType":"administrative","elementType":"geometry","stylers":[{"color":"#a7a7a7"}]},{"featureType":"road.arterial","elementType":"geometry.fill",
"stylers":[{"color":"#ffffff"}]},{"featureType":"road.arterial","elementType":"geometry.fill","stylers":[{"color":"#ffffff"}]},{"featureType":"landscape","elementType":"geometry.fill","stylers":[{"visibility":"on"},{"color":"#efefef"}]},{"featureType":"road","elementType":"labels.text.fill","stylers":[{"color":"#696969"}]},{"featureType":"administrative","elementType":"labels.text.fill","stylers":[{"visibility":"on"},{"color":"#737373"}]},{"featureType":"poi","elementType":"labels.icon","stylers":[{"visibility":"off"}]},
{"featureType":"poi","elementType":"labels","stylers":[{"visibility":"off"}]},{"featureType":"road.arterial","elementType":"geometry.stroke","stylers":[{"color":"#d6d6d6"}]},{"featureType":"road","elementType":"labels.icon","stylers":[{"visibility":"off"}]},{},{"featureType":"poi","elementType":"geometry.fill","stylers":[{"color":"#dadada"}]}]},$("#home-contact-map"));this.contact_map.add_to_overlay($("#home-contact-map-overlay"))};
...
sagewest.page.Home.prototype.scroll_to_target=function(str_param,str_param_2,str_param_3){sagewest.page.Home.superClass_.scroll_to_target.call(this,str_param)};sagewest.page.Home.prototype.on_scroll_to_no_target=function(){};goog.exportSymbol("sagewest.page.Home",sagewest.page.Home);
